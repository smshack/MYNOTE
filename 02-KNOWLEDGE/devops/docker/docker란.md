...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/b150807f-17b3-4a96-8a80-0752824ce4ed/Untitled.png)
도커는 다양한 클라우드 서비스 모델과 같이 사용 가능

- 이미지: 필요한 프로그램과 라이브러리, 소스를 설치한 뒤 만든 하나의 파일
- 컨테이너: 이미지를 격리하여 독립된 공간에서 실행한 가상 환경
![[Pasted image 20251115030348.png]]
## 1.1 컨테이너가 해결한다!
...
![[Pasted image 20251115030400.png]]
하이퍼바이저의 필요 없는 공간을 활용하면 더 많은 자원을 앱에 투자 가능

## 1.2 컨테이너 성능 비교
![[Pasted image 20251115030410.png]]

![[Pasted image 20251115030434.png]]

![[Pasted image 20251115030445.png]]
...
![[Pasted image 20251115030524.png]]
**리눅스 컨트롤 그룹**

프로세스로 소비할 수 있는 리소스 양(CPU, 메모리, I/O, 네트워크 대역대, device 노드 등)을 제한
![[Pasted image 20251115030532.png]]
## 1.4 도커의 한계
...
![[Pasted image 20251115030636.png]]
## 도커 명령어로 검색
...
# 3. 도커 라이프 사이클 명령어 실습
![[Pasted image 20251115030644.png]]
## 도커 이미지 다운로드와 삭제
...
## 레이어의 개념
![[Pasted image 20251115030653.png]]
## 도커 이미지 정보 확인
...
```
![[Pasted image 20251115030705.png]]
![[Pasted image 20251115030713.png]]
...
```
![[Pasted image 20251115030728.png]]
![[Pasted image 20251115030736.png]]

# 6. 도커에서 쿠버로 넘어간 이유
![[Pasted image 20251115030743.png]]
![[Pasted image 20251115030750.png]]
...
### 백엔드 어플리케이션 빌드 및 실행
![[Pasted image 20251115030813.png]]![[Pasted image 20251115030825.png]]
![[Pasted image 20251115030838.png]]